...
NUM_TIMESTEPS = 100
DT = 0.01
SIMULATE_FORWARD_DT_OPTIONS = [0.05, 0.1]
...
def main():
    ...
    results_dir = f"./ablations/coarse_simulate_fine_ablation_{timestamp}"
    ...
    config = {
        ...
        "dt": DT,
        "simulate_forward_dt_options": SIMULATE_FORWARD_DT_OPTIONS,
    ...
    print(f"\n=== Running Coarse Simulate Fine Ablation (dt={DT}, 100 timesteps) ===\n")
